...
subprocess.Popen(["python", "peer.py", "p1", "9001"])
time.sleep(1)
subprocess.Popen(["python", "peer.py", "p2", "9002"])
time.sleep(1)
subprocess.Popen(["python", "peer.py", "p3", "9003"])
time.sleep(1)
subprocess.Popen(["python", "peer.py", "p4", "9004"])
time.sleep(1)
subprocess.Popen(["python", "peer.py", "p5", "9005"])
time.sleep(1)
subprocess.Popen(["python", "peer.py", "p6", "9006"])
time.sleep(1)
